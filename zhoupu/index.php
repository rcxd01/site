...
<?php
if($prescription){
	echo "<title>".$prescription." - 粥谱 - 生活查询 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇查询工具</title>";
	echo '<meta name="keywords" content="要哇查询,生活查询,娱乐工具,财务商务,计算|学习查询,电脑网络,站长工具,交通查询,'.$prescription.',粥谱,谱" />';
}elseif($id>0 && $id<=$count){
	echo "<title>".$detail[0]." - 粥谱 - 生活查询 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇查询工具</title>";
	echo '<meta name="keywords" content="要哇查询,生活查询,娱乐工具,财务商务,计算|学习查询,电脑网络,站长工具,交通查询,'.$detail[0].',粥谱,谱" />';
	echo '<meta name="description" content="要哇查询,生活查询,娱乐工具,财务商务,计算|学习查询,电脑网络,站长工具,交通查询,'.trim(str_replace("<br>","",$detail[1]),"　 ").'粥谱。" />';
}else{
	echo "<title>粥谱 - 生活查询 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇查询工具</title>";
	echo '<meta name="keywords" content="要哇查询,生活查询,娱乐工具,财务商务,计算|学习查询,电脑网络,站长工具,交通查询,粥谱,谱" />';
}
?>
...
<div class="w950">
  <div class="head4">
    <div class="Ico_aBox">
      <div class="Ico_aBox_icon INico17"></div>
      <div class="Ico_aBox_tit">粥谱</div>
      <div class="Ico_aBox_intro">粥谱</div>
    </div>
  </div>
  <div class="knr">
    <div class="mobile_main">
<table width="700" cellpadding="2" cellspacing="0" class="mob_ace" style="border:1px solid #A4C4DC;" id="top"><tr><td align="center" valign="middle" height="60"><form action="./" method="get" name="f1">搜索粥谱：<input name="q" id="q" type="text" size="18" delay="0" value="" style="width:200px;height:22px;font-size:16px;font-family: Geneva, Arial, Helvetica, sans-serif;" /> <input type="submit" class="mob_copy1" value=" 搜索 " /></form></td></tr><tr><td align="center" height="30" style="font-size:14px;">输入最短的关键字，如<a href="./?q=%D1%F2%C8%E2">羊肉山药粥</a>,输入<a href="./?q=%D1%F2%C8%E2">羊肉</a>后按Enter即可</td></tr></table><div style='height:10px;'></div>
<table width="700" cellpadding="2" cellspacing="0" class="mob_ace" style="border:1px solid #A4C4DC;"><tr><td style="background:url(/img/kuang5.gif);padding:0 5px;color:#014198;" height="26" valign="middle" colspan="5"><b>什么是粥谱？</b></td></tr><tr><td><p style="line-height:150%">　喝粥对人体的好处：1、容易消化；2、增强食欲，补充体力；3、防止便秘；4、预防感冒；5、防止喉咙干涩；6、调养肠胃；7、延年益寿；<br>　中医认为，小米和大米味甘性平，都具有补中益气、健脾和胃的作用。二者用来熬粥后，很大一部分营养进入汤中，其中尤以粥油中最为丰富，是米汤的精华，滋补力之强，丝毫不亚于人参、熟地等名贵的药材。<br>　粥熬好后，上面浮着一层细腻、黏稠、形如膏油的物质，中医里叫做“米油”，俗称粥油。通常所说的粥油是由小米或大米熬粥后所得的。
