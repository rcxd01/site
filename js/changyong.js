...
function get_mobile(){
	$("#mobResult").ajaxStart(function(){$(this).html('<div class="loading">正在加载...</div>')})
...
function getpet() {
	...
	$("#shuxiang").ajaxStart(function(){$(this).html('<div class="loading">正在加载...</div>')})
	$.ajax({
		type: "get",
		cache:false,
...
function get_cy(){
	...
	$("#chengyu").ajaxStart(function(){$(this).html('<div class="loading">正在加载...</div>')})
...
function get_ciyu(){
	...
	$("#ciyu").ajaxStart(function(){$(this).html('<div class="loading">正在加载...</div>')})
