...
<title>QQ吉凶测试 - 娱乐工具 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇实用查询</title>
...
<div class="w950">
     <div class="head4">
           <div class="Ico_aBox">
                <div class="Ico_aBox_icon INico73"></div>
                <div class="Ico_aBox_tit">QQ号码吉凶</div>
                <div class="Ico_aBox_intro">QQ号码吉凶测试</div>
			</div>
     </div>
<div class="knr">
