...
Const DomainRoot = "pipidao.com"      '网站域名根
...
Const SiteManageCode = "Powereasy"  '后台管理认证码，您可以修改成您的管理员认证码：×××××××××

Const MaxPerPage_Create = 50   '生成HTML时，每页生成的数量，建议不要超过100，否则可能会导致页面超时
Const SleepTime = 0            '每页生成完毕后，暂停时间， 单位为秒。如果为0，则不暂停，生成当前页面后马上跳转到下一页继续生成。建议设置为3－10
%>
