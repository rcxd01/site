...
<?php
if($prescription){
	echo "<title>".$prescription." - 周公解梦大全 - 生活查询 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇实用查询</title>";
	echo '<meta name="keywords" content="'.$prescription.',周公解梦,中医解梦,中药解梦,解梦大全" />';
}elseif($id>0 && $id<=$count){
	echo "<title>".$detail[1]." - ".$detail[0]." - 周公解梦大全 - 娱乐工具 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇实用查询</title>";
	echo '<meta name="keywords" content="要哇查询,生活查询,娱乐工具,财务商务,计算|学习查询,电脑网络,站长工具,交通查询,'.$detail[1].",".$detail[0].',解梦,周公解梦大全" />';
}else{
	echo "<title>周公解梦大全 - 生活查询 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇实用查询</title>";
	echo '<meta name="keywords" content="要哇查询,生活查询,娱乐工具,财务商务,计算|学习查询,电脑网络,站长工具,交通查询,周公解梦,中医解梦,中药解梦,解梦大全" />';
	echo '<meta name="description" content="周公解梦大全，《周公解梦大全查询》收录国内最多的梦境破解，是国内最大的周公解梦系统，以原版周公解梦为基础演绎扩充，结合周易占卜原理，为您解开您梦境中的秘密。《周公解梦》是古代一部关于梦的解析与占卜的书，相传为周公所作，其解梦系按《周易》取象推演而来。" />';
}
?>
...
<div class="w950">
  <div class="head4">
    <div class="Ico_aBox">
      ...
      <div class="Ico_aBox_tit">周公解梦大全</div>
      <div class="Ico_aBox_intro">周公解梦大全</div>
    </div>
  </div>
  <div class="knr">
    <div class="mobile_main">
<table width="700" cellpadding="2" cellspacing="0" style="border:1px solid #A4C4DC;" id="top"><tr><td align="center" valign="middle" height="60"><form action="./" method="get" name="f1"><b>搜索解梦：</b><input name="q" id="q" type="text" size="18" delay="0" value="" style="width:200px;height:22px;font-size:16px;font-family: Geneva, Arial, Helvetica, sans-serif;" /> <input type="submit" class="mob_copy1" value=" 搜索 " /></form></td></tr><tr><td align="center" height="30" style="font-size:14px;">解梦分类：<a href="./?q=%C9%FA%BB%EE%C6%AA">生活</a> <a href="./?q=%CC%EC%CF%F3%C6%AA">天象</a> <a href="./?q=%C9%BD%B5%D8%C6%AA">山地</a> <a href="./?q=%C6%F7%CE%EF%C6%AA">器物</a> <a href="./?q=%BD%A8%D6%FE%C6%AA">建筑</a> <a href="./?q=%CE%C4%BB%AF%C6%AA">文化</a> <a href="./?q=%D6%B2%CE%EF%C6%AA">植物</a> <a href="./?q=%B6%AF%CE%EF%C6%AA">动物</a> <a href="./?q=%C9%F1%B9%ED%C6%AA">神鬼</a> <a href="./?q=%C8%CB%C9%ED%C6%AA">人身</a> <a href="./?q=%C7%E9%B0%AE%C6%AA">情爱</a> <a href="./?q=%C6%E4%CB%FC%C6%AA">其他</a></td></tr></table><div style='height:10px;'></div>
<?php
if($prescription!=""){
	//echo $pf_l.$pf;
	echo $pf_l;
