...
<?php
if($prescription){
	echo "<title>".$prescription." - 民间谚语大全 - 生活查询 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇查询工具</title>";
	echo '<meta name="keywords" content="'.$prescription.',民间谚语,英文谚语" />';
}elseif($id>0 && $id<=$count){
	echo "<title>".$detail[1]." - ".$detail[0]." - 民间谚语大全 - 娱乐工具 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇查询工具</title>";
	echo '<meta name="keywords" content="要哇查询,生活查询,娱乐工具,财务商务,计算|学习查询,电脑网络,站长工具,交通查询,'.$detail[1].",".$detail[0].',解梦,周公解梦大全" />';
}else{
	echo "<title>民间谚语大全 - 生活查询 - - IP地址查询|手机号码归属地查询|身份证|电话号码查询|黄历|万年历|区号|各种查询|- 要哇查询工具</title>";
	echo '<meta name="keywords" content="要哇查询,生活查询,娱乐工具,财务商务,计算|学习查询,电脑网络,站长工具,交通查询,民间谚语,中医解梦,中药解梦,解梦大全" />';
...
<div class="w950">
  <div class="head4">
    <div class="Ico_aBox">
      <div class="Ico_aBox_icon INico50"></div>
      <div class="Ico_aBox_tit">民间谚语大全</div>
      <div class="Ico_aBox_intro">民间谚语/英文谚语</div>
    </div>
  </div>
  <div class="knr">
    <div class="mobile_main">
<table width="700" cellpadding="2" cellspacing="0" style="border:1px solid #A4C4DC;" id="top"><tr><td align="center" valign="middle" height="60"><form action="./" method="get" name="f1"><b>搜索谚语：</b><input name="q" id="q" type="text" size="18" delay="0" value="" style="width:200px;height:22px;font-size:16px;font-family: Geneva, Arial, Helvetica, sans-serif;" /> <input type="submit" class="mob_copy1" value=" 搜索 " /></form></td></tr><tr><td align="center" height="30" style="font-size:14px;">输入最短的关键字，如<a href="./?q=%C2%E6%CD%D5">瘦死的骆驼比马大</a>，输入<a href="./?q=%C2%E6%CD%D5">骆驼</a>后按Enter即可</td></tr></table><div style='height:10px;'></div>
<?php
if($prescription!=""){
	//echo $pf_l.$pf;
	echo $pf_l;
	...
	echo '<table width="700" cellpadding="2" cellspacing="0" class="mob_ace" style="border:1px solid #A4C4DC;"><tr><td style="background:url(/img/kuang5.gif);padding:0 5px;color:#014198;" height="26" valign="middle" colspan="5"><b>民间谚语大全</b></td></tr><tr><td><p style="line-height:150%;font-size:12px;">　　谚语是人民群众口头流传的习用的固定语句，用简单通俗的话来反映深刻的道理。 谚语是民间集体创造、广为口传、言简意赅并较为定型的艺术语句，是民众丰富智慧和普遍经验的规律性总结。恰当地运用谚语可使语言活泼风趣，增强文章的表现力。谚语多半在民间口语中广泛流传，表达人们丰富的社会生活经验，闪耀着人民智慧的光芒。谚语不仅是我们中华民族的结晶，同时在外国也收到广泛应用。谚语反映的内容涉及到社会生活的各个方面。<br>　　本谚语大全收录各类谚语5000余条，共计69类；涵盖方面广，是目前最全的谚语类查询工具！</p></td></tr></table>
<br>';
	echo $pf_l;
}
?>
